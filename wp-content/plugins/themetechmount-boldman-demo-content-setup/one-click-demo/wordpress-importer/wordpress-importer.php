...
require  BOLDMAN_TMDC_DIR . 'one-click-demo/wordpress-importer/parsers.php';
...
function wordpress_importer_init() {
	load_plugin_textdomain( 'wordpress-importer', false, get_template_directory() . '/inc/one-click-demo/wordpress-importer/languages' );
