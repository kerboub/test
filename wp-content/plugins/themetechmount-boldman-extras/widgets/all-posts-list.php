 ...
 * @since 1.0
 */
class boldman_all_post_list_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_style = array('classname'   => 'boldman_all_post_list_widget',
							  'description' => esc_attr__('Show All Post List of current Taxonomy.', 'boldman') );
		parent::__construct(
			'boldman_all_post_list_widget', // Base ID
			esc_attr__('Boldman All Post List Widget', 'boldman'), // Name
			$widget_style // Args
		);
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e( 'Title:', 'boldman' ); ?></label>
		<input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

		<p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_attr_e( 'Number of posts to show:', 'boldman' ); ?></label> <br>
...
register_widget( 'boldman_all_post_list_widget' );