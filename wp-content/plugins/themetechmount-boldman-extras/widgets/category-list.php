 ...
 * @since 1.0
 */
class boldman_category_list_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_style = array('classname'   => 'boldman_category_list_widget',
							  'description' => esc_attr__('Show Category List of current Taxonomy.', 'boldman') );
		parent::__construct(
			'boldman_category_list_widget', // Base ID
			esc_attr__('Boldman Category/Group List Widget', 'boldman'), // Name
			$widget_style // Args
		);
	}
	...
	function form( $cur_instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e('Title', 'boldman'); ?>:</label>
...
register_widget( 'boldman_category_list_widget' );