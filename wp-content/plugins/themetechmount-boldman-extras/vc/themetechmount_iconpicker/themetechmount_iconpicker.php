...
/**** Icon Libraries ****/
function themetechmount_boldman_enqueue_icon_libraries(){
...
add_action( 'wp_enqueue_scripts', 'themetechmount_boldman_enqueue_icon_libraries' );
 ...
 */
function themetechmount_boldman_admin_scripts_styles() {
	...
	// iconset-themify
	wp_enqueue_script( 'iconset-kw_boldman', TMTE_URI . '/vc/themetechmount_iconpicker/iconset-kw_boldman.js', array( 'bootstrap' ) );
	...
	// iconset-kw_boldman
	wp_enqueue_style( 'kw_boldman', get_template_directory_uri().'/assets/themetechmount-boldman-extra-icons/font/flaticon.css' );
...
add_action( 'admin_enqueue_scripts', 'themetechmount_boldman_admin_scripts_styles' );
