...
function themetechmount_boldman_cpt_tm_client(){
	...
	function themetechmount_boldman_tm_client_enter_title_here( $title ){
	...
	add_filter( 'enter_title_here', 'themetechmount_boldman_tm_client_enter_title_here' );




	// Move Featured Image box from left to center only on CLIENTS custom_post_type
	add_action('do_meta_boxes', 'themetechmount_boldman_tm_client_featured_image_box');
	function themetechmount_boldman_tm_client_featured_image_box() {
...
add_action( 'init', 'themetechmount_boldman_cpt_tm_client', 8 );
 ...
 *  Meta Box: Clients
 */
if ( ! function_exists( 'themetechmount_boldman_tm_client_metabox_options' ) ) {
function themetechmount_boldman_tm_client_metabox_options( $options ) {
	...
	$options[]    = array(
		...
		'title'     => esc_attr__('Boldman: Client Details', 'tmte'),
...
if( function_exists('cs_framework_init') ){
	add_filter( 'cs_metabox_options', 'themetechmount_boldman_tm_client_metabox_options' );
}