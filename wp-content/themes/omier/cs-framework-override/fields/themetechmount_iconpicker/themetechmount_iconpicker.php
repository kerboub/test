...
class CSFramework_Option_themetechmount_iconpicker extends CSFramework_Options {
  ...
  public function output(){
	...
	$icon_library_array = array( // all icon library list array
		'themify'        => array( esc_attr__( 'Themify icons', 'boldman' ), 'ti-location-pin'),
		'linecons'       => array( esc_attr__( 'Linecons', 'boldman' ),      'li_star'),
		'kw_boldman'     => array( esc_attr__( 'Boldman Icons', 'boldman' ), 'flaticon-fruits'),
	);
	...
	$icon_picker_html    = '';
	$icon_dropdown_array = array( esc_attr__( 'Font Awesome', 'boldman' )    => 'fontawesome' );
