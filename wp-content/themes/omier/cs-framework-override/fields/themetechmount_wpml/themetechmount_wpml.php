...
class CSFramework_Option_themetechmount_wpml extends CSFramework_Options {
  ...
  public function output(){
	...
	$config['box_title']		= esc_attr__( 'Multilingual Boldman Theme', 'boldman' );
	$config['name']				= esc_attr( 'Boldman' ); //name of theme/plugin
	$config['box_description']	= esc_attr__('Boldman theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.', 'boldman' );
