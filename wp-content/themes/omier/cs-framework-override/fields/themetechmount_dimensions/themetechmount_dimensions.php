...
class CSFramework_Option_themetechmount_dimensions extends CSFramework_Options {
  ...
  public function output(){
	...
	echo '<input placeholder="'. esc_attr__('Width', 'boldman') .'" type="'. $this->element_type() .'" name="'. $this->element_name( '[width]' ) .'" value="'. $value_width .'"'. $this->element_class('mini') . $this->element_attributes() .'/>';
	...
	echo '<input placeholder="'. esc_attr__('Height', 'boldman') .'" type="'. $this->element_type() .'" name="'. $this->element_name( '[height]' ) .'" value="'. $value_height .'"'. $this->element_class('mini') . $this->element_attributes() .'/>';
	echo '<span class="add-on add-on-right"> px</span>';
	echo '</div>';
