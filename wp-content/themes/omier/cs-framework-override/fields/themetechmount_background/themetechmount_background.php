...
class CSFramework_Option_themetechmount_background extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title   = ( isset( $button_title ) ) ? $button_title : esc_attr__( 'Upload', 'boldman' );
    $frame_title    = ( isset( $frame_title  ) ) ? $frame_title  : esc_attr__( 'Upload', 'boldman' );
    $insert_title   = ( isset( $insert_title ) ) ? $insert_title : esc_attr__( 'Use Image', 'boldman' );
	...
	$btntext_add    = esc_attr__('Add image','boldman');
	$btntext_change = esc_attr__('Change image','boldman');
	$btntext        = ( empty( $value ) )  ? esc_attr__('Add image','boldman') : esc_attr__('Change image','boldman');
	...
	echo '<div class="cs-image-preview"><div class="cs-preview"><div class="cs-preview-inner">
			...
			<img src="'. esc_attr($preview) .'" alt="' . esc_attr__('preview','boldman') . '" class="'. esc_attr($hidden) .'" />
			<div class="tm-cs-background-heading-noimg'. esc_attr($hidden_text) .'"> ' . esc_attr__('No image selected for background','boldman') . ' </div>
		</div></div></div>';
	...
	echo '<small>'. esc_attr__('BG image repeat','boldman') .'</small>';
	...
	echo '<small>'. esc_attr__('BG image position','boldman') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	echo '<small>'. esc_attr__('BG image attachment','boldman') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	echo '<small>'. esc_attr__('BG image size','boldman') .'</small>';
    echo cs_add_element( array(
        'pseudo'          => true,
        'type'            => 'select',
	...
	if( isset($this->field['color']) && $this->field['color']==false ){
		...
		echo '<small>'. esc_attr__('BG image color','boldman') .'</small>';
		echo cs_add_element( array(
			'pseudo'          => true,
