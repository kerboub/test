...
if( !empty($boldman_theme_options['fbar_widget_column_layout']) ){
	$floatingbar_col = esc_attr($boldman_theme_options['fbar_widget_column_layout']);
}
?>

<div id="floatingbar-widgets" class="row multi-columns-row sidebar-container floatingbar-text-color-<?php echo sanitize_html_class($boldman_theme_options['fbar_text_color']); ?>" role="complementary">
