<article class="themetechmount-box themetechmount-box-events themetechmount-box-view-top-image themetechmount-events-box-view-top-image">
	<div class="themetechmount-post-item">
		...
		<div class="event-box-content">			
			<div class="themetechmount-box-meta themetechmount-events-meta"><?php echo themetechmount_wp_kses( themetechmount_event_meta() ); ?><?php echo themetechmount_wp_kses( themetechmount_event_venue() ); ?></div>
