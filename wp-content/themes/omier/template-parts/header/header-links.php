...
$header_search = ( !isset($boldman_theme_options['header_search']) ) ? '1' : esc_attr($boldman_theme_options['header_search']);
...
<div class="header-controls">
	...
	<?php endif; ?>
	<?php
	$wc_header_icon = ( isset($boldman_theme_options['wc-header-icon']) && trim($boldman_theme_options['wc-header-icon'])!='' ) ? esc_attr($boldman_theme_options['wc-header-icon']) : '1' ;
