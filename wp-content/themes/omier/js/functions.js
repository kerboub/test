...
function boldman_logMarginPadding_content(){
	jQuery('.vc_column_container.tm-expandcontent-yes').each(function(){
		...
		if( jQuery(this).hasClass('tm-right-span') ){
			tm_column_div = ', .vc_column-inner > .wpb_wrapper:not(.tm_column_wrapper)';
			jQuery('.vc_column-inner > .cmt-col-wrapper-bg-layer'+tm_column_div, jQuery(this)).css( 'margin-right','-'+extra_size+'px' );
		} else if( jQuery(this).hasClass('tm-left-span') ){
			tm_column_div = ', .vc_column-inner > .wpb_wrapper:not(.cmt_column_wrapper)';
			jQuery('.vc_column-inner > .cmt-col-wrapper-bg-layer'+tm_column_div, jQuery(this)).css( 'margin-left','-'+extra_size+'px' );
		}
	});
}
...
// Top btn click event
	...
	boldman_logMarginPadding_content();	
	/*------------------------------------------------------------------------------*/
