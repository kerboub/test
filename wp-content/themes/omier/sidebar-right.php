...
if( is_page() ){
...
} elseif( is_singular('tm_service') ) {  // Service
...
} elseif( is_tax('tm_service_category') ) {  // Service category
	...
	$sidebar_right = esc_attr($boldman_theme_options['sidebar_post']); // Global settings
	$sidebar_right = 'sidebar-right-blog';
