<?php
/**
 * Boldman functions and definitions
 *
...
if ( ! function_exists( 'boldman_setup' ) ) :
/**
...
function boldman_setup() {
	 ...
	 * If you're building a theme based on boldman, use a find and replace
	 * to change 'boldman' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'boldman', get_template_directory() . '/languages' );
	...
	register_nav_menus( array( // https://codex.wordpress.org/Function_Reference/has_nav_menu
		'tm-main-menu'			=> esc_html__( 'Main Menu', 'boldman' ),
		'tm-footer-menu'		=> esc_html__( 'Footer Menu', 'boldman' ),
		'tm-topbar-left-menu'	=> esc_html__( 'Topbar Left Menu', 'boldman' ),
		'tm-topbar-right-menu'	=> esc_html__( 'Topbar Right Menu', 'boldman' ),
	) );
	
}
endif; // boldman_setup()
add_action( 'after_setup_theme', 'boldman_setup' );
