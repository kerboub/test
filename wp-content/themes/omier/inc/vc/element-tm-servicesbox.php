...
$allParams = array_merge(
		...
		array( 
			array(
				...
				"description" => sprintf( esc_attr__("Show sortable category links above %s items so user can sort by just single click.",'boldman'), $service_type_title_singular ),
				"param_name"  => "sortable",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("Show pagination links below %s boxes.",'boldman'), $service_type_title ),
			...
			array(
				"type"        => "checkbox",
				"heading"     => sprintf( esc_attr__("From %s", "boldman"), $service_cat_title_singular ),
				"description" => sprintf( esc_attr__('If you like to show %1$s from selected %2$s than select the category here.', "boldman"), $service_type_title, $service_cat_title ),
			...
			array(
				...
				"description" => esc_attr__("Sort retrieved service by parameter.",'boldman'),
				"param_name"  => "orderby",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_attr__("How many %s item you want to show.", "boldman"), $service_type_title ),
				"param_name"  => "show",
				"value"       => array(
...
vc_map( array(
	"name"     => sprintf( esc_attr__("ThemetechMount %s Box",'boldman'), $service_type_title_singular ),
	"base"     => "tm-servicesbox",
	"class"    => "",
