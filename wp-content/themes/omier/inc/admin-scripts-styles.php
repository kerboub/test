 ...
 * @return void
 */
if( !function_exists('boldman_wp_admin_scripts_styles') ){
function boldman_wp_admin_scripts_styles() {
	
	/* Core files of the theme */
	wp_enqueue_style( 'boldman-custom-wp-admin-css', get_template_directory_uri() . '/inc/admin-style.css', false, '1.0.0' );
	wp_enqueue_script( 'boldman-custom-js', get_template_directory_uri() . '/inc/admin-custom.js', array( 'jquery' ) );
...
add_action( 'admin_enqueue_scripts', 'boldman_wp_admin_scripts_styles' );